...
//打包到对应的文件目录
var cssSrc= ['views/css/**','!views/css/**/*.map'],
    cssDest = 'dist/css',
    cssRev = 'rev/css',
    jsSrc = ['views/js/**/controller/*.js','views/js/**/*_main.js'],
    jsDest = 'dist/js',
    jsRev = 'rev/js',
    fontSrc = 'views/font/**',
    fontDest = 'dist/font',
...
gulp.task('revCssDist', function(){
    return gulp.src(['views/css/**/*.css','!views/css/bootstrap.css','!views/css/light7.min.css','!views/css/bootstrap-theme.min.css','!views/css/font-awesome.min.css'])
        .pipe(rev())
        .pipe(gulp.dest(cssDest))
        .pipe(rev.manifest())
...
gulp.task('rjs', function () {
    return gulp.src(jsSrc)
        .pipe(requirejsOptimize({
            ...
            exclude:['layer1','handlebars','jquery','laydate','weui','pagination','jquery.layout', 'autoLineNumber']
        }))
