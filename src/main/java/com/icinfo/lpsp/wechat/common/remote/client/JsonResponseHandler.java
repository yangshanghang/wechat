...
public class JsonResponseHandler {
     ...
     * @return
     */
    public static <T> ResponseHandler<T> createResponseHandler(Map<String, String> requestInfo, final Class<T> clazz) {
    ...
    public static class JsonResponseHandlerImpl<T> extends BaseResponseHandler implements ResponseHandler<T> {
         ...
         * @param clazz 类型
         */
        public JsonResponseHandlerImpl(Map<String, String> requestInfo, Class<T> clazz) {
